package br.com.spacevips.core.platform.bukkit.database;
...
public class MySQL {
    ...
    public void openConnection() {
        try {
            ...
            Bukkit.getConsoleSender().sendMessage("[SpaceVips] [Premium] §aConnected to MySQL successfully");
    ...
    private void criarTabelas() {
        criarTabela("informacoes", "nome varchar(16), vips int");
    }
}